...
def main():
    ...
    parser = ArgumentParser(prog='cipherman', description='Encrypt or Decrypt a plain text or a text file using Classical Encryption Techniques. Supported techniques: "1.Caesar Cipher" "2.Monoalphabetic Cipher" "3.Playfair Cipher" "4.Hill Cipher"')


    parser.add_argument('-v', '--version', action='version', version='cipherman 1.2.0', help='show program version and exit')

    group_one = parser.add_mutually_exclusive_group()
    group_two = parser.add_mutually_exclusive_group()

    parser.add_argument("-a", "--algorithm",
                    choices=['caesar', 'mono', 'play', 'hill'],
